                ...
                <div className="col l-6 payment">
                  <div className="payment__heading">
                    ...
                    <div className="payment__cat">
                      <img src="img/meobeo.jpg" style={{ width: "56%" }} />
                    </div>
                  </div>
                  ...
                  <div className="payment__choose">
                      ...
                      <span className="payment__desc">Thanh toán này được mã hóa và thông tin của của luôn được bảo mật</span>
                  </div>
                </div>
              </div>
            </div>
